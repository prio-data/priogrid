...
that extracts sparse/no vegetation coverage proportions (class code 66)
for PRIO-GRID cells.

## Usage

``` r
gen_hilda_sparse(config = pg_current_config())
```

## Value

A `SpatRaster` with sparse/no vegetation coverage proportions (0-1) for
