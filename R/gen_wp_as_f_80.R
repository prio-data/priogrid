...
#'
#' @export
gen_wp_as_f_80_sum <- function(input_folder, fun = "sum"){
  
  years <- 2000:2020
  
  fnames <- paste0("global_f_80_", years, "_1km.tif")
  
  var <- paste0("wp_as_f_80_", as.character(fun))
...
#'
#' @export
gen_wp_as_f_80_sd <- function(input_folder){
  gen_wp_as_f_80_sum(input_folder, fun = "sd")
}
...
#'
#' @export
gen_wp_as_f_80_max <- function(input_folder){
  gen_wp_as_f_80_sum(input_folder, fun = "max")
}
...
#'
#' @export
gen_wp_as_f_80_min <- function(input_folder){
  gen_wp_as_f_80_sum(input_folder, fun = "min")
}
...
#'
#' @export
gen_wp_as_f_80_mean <- function(input_folder){
  gen_wp_as_f_80_sum(input_folder, fun = "mean")
}
...
#'
#' @export
gen_wp_as_f_80_med <- function(input_folder){
  gen_wp_as_f_80_sum(input_folder, fun = "median")
}
