...
gen_pop_gpw_sum <- function(input_folder, fun = "sum", interpolate_time = FALSE, interpolate_missing = FALSE){
  ...
  gpw <- raster::brick(file.path(input_folder, "input", "pop_gpw", "gpw_v4_population_count_rev11_2pt5_min.nc"))
...
gen_pop_gpw_sd <- function(input_folder, interpolate_time = FALSE, interpolate_missing = TRUE){
  ...
  gen_pop_gpw_sum(input_folder, fun = "sd", interpolate_time = interpolate_time, interpolate_missing = interpolate_missing)
}
...
gen_pop_gpw_min <- function(input_folder, interpolate_time = FALSE, interpolate_missing = TRUE){
  ...
  gen_pop_gpw_sum(input_folder, fun = "min", interpolate_time = interpolate_time, interpolate_missing = interpolate_missing)
}
