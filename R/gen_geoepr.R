...
#' Group status derived from the EPR Core 2021 dataset, and location derived from the GeoEPR 2021 data. The variable counts only
...
prep_epr <- function(input_folder){
  ...
  files <- file.path(input_folder, "input", "geoepr", c("GeoEPR-2021.shp","EPR-2021.csv"))
