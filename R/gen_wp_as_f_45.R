...
#'
#' @export
gen_wp_as_f_45_sum <- function(input_folder, fun = "sum"){
  
  years <- 2000:2020
  
  fnames <- paste0("global_f_45_", years, "_1km.tif")
  
  var <- paste0("wp_as_f_45_", as.character(fun))
...
#'
#' @export
gen_wp_as_f_45_sd <- function(input_folder){
  gen_wp_as_f_45_sum(input_folder, fun = "sd")
}
...
#'
#' @export
gen_wp_as_f_45_max <- function(input_folder){
  gen_wp_as_f_45_sum(input_folder, fun = "max")
}
...
#'
#' @export
gen_wp_as_f_45_min <- function(input_folder){
  gen_wp_as_f_45_sum(input_folder, fun = "min")
}
...
#'
#' @export
gen_wp_as_f_45_mean <- function(input_folder){
  gen_wp_as_f_45_sum(input_folder, fun = "mean")
}
...
#'
#' @export
gen_wp_as_f_45_med <- function(input_folder){
  gen_wp_as_f_45_sum(input_folder, fun = "median")
}
