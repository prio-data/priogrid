#' shdi
#'
#' Gives the subnational human development index (SHDI) within each grid cell, based on SHDI data v. 7.
#' The index is an average of values along three dimensions: education, health, and standard of living. Available from 1990 to 2021.
#'
...
gen_shdi <- function(input_folder, variable = "shdi", add_missing_geometries = FALSE){
  ...
  shdi <- read.csv(file.path(input_folder, "gdl", "SHDI-SGDI-Total 7.0.csv"))
...
#' msch
#'
#' Gives the mean years of schooling for population aged 25+ within each grid cell, based on SHDI data v. 7. Available from 1990 to 2021.
#'
#' Links to original data: https://globaldatalab.org/shdi/shapefiles/ and https://globaldatalab.org/shdi/download_files/.
#'
#' Please cite: Smits, J., Permanyer, I. The Subnational Human Development Database. Sci Data 6, 190038 (2019). https://doi.org/10.1038/sdata.2019.38
...
#'
#' @export
gen_msch <- function(input_folder, add_missing_geometries = FALSE){ gen_shdi(input_folder, variable = "msch", add_missing_geometries = add_missing_geometries) }


#' esch
#'
#' Gives the expected years of schooling for children aged 6 within each grid cell, based on SHDI data v. 7. Available from 1990 to 2021.
#'
#' Links to original data: https://globaldatalab.org/shdi/shapefiles/ and https://globaldatalab.org/shdi/download_files/.
#'
#' Please cite: Smits, J., Permanyer, I. The Subnational Human Development Database. Sci Data 6, 190038 (2019). https://doi.org/10.1038/sdata.2019.38
...
#'
#' @export
gen_esch <- function(input_folder, add_missing_geometries = FALSE){ gen_shdi(input_folder, variable = "esch", add_missing_geometries = add_missing_geometries) }


#' lifexp
#'
#' Gives the life expectancy at birth within each grid cell, based on SHDI data v. 7. Available from 1990 to 2021.
#'
#' Links to original data: https://globaldatalab.org/shdi/shapefiles/ and https://globaldatalab.org/shdi/download_files/.
#'
#' Please cite: Smits, J., Permanyer, I. The Subnational Human Development Database. Sci Data 6, 190038 (2019). https://doi.org/10.1038/sdata.2019.38
...
#'
#' @export
gen_lifexp <- function(input_folder, add_missing_geometries = FALSE){ gen_shdi(input_folder, variable = "lifexp", add_missing_geometries = add_missing_geometries) }


#' gnic
#'
#' Gives the Gross National Income per capita in thousands of USD (2011 PPP) within each grid cell, based on SHDI data v. 7. Available from 1990 to 2021.
#'
#' Links to original data: https://globaldatalab.org/shdi/shapefiles/ and https://globaldatalab.org/shdi/download_files/.
#'
#' Please cite: Smits, J., Permanyer, I. The Subnational Human Development Database. Sci Data 6, 190038 (2019). https://doi.org/10.1038/sdata.2019.38
...
#'
#' @export
gen_gnic <- function(input_folder, add_missing_geometries = FALSE){ gen_shdi(input_folder, variable = "gnic", add_missing_geometries = add_missing_geometries) }
