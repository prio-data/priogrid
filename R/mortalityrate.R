...
read_sedac_global_infant_mortality_rates <- function() {
  ...
  fname <- here("/Users/ingvildsmestad/Desktop/Gitprodjects/raw_data/povmap-global-subnational-infant-mortality-rates-v2-01-geotiff-2/povmap_global_subnational_infant_mortality_rates_v2_01.tif")
  r <- terra::rast(fname)
