...
#'
#' @export
gen_wp_as_m_65_sum <- function(input_folder, fun = "sum"){
  
  years <- 2000:2020
  
  fnames <- paste0("global_m_65_", years, "_1km.tif")
  
  var <- paste0("wp_as_m_65_", as.character(fun))
...
#'
#' @export
gen_wp_as_m_65_sd <- function(input_folder){
  gen_wp_as_m_65_sum(input_folder, fun = "sd")
}
...
#'
#' @export
gen_wp_as_m_65_max <- function(input_folder){
  gen_wp_as_m_65_sum(input_folder, fun = "max")
}
...
#'
#' @export
gen_wp_as_m_65_min <- function(input_folder){
  gen_wp_as_m_65_sum(input_folder, fun = "min")
}
...
#'
#' @export
gen_wp_as_m_65_mean <- function(input_folder){
  gen_wp_as_m_65_sum(input_folder, fun = "mean")
}
...
#'
#' @export
gen_wp_as_m_65_med <- function(input_folder){
  gen_wp_as_m_65_sum(input_folder, fun = "median")
}
