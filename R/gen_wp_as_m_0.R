...
#'
#' @export
gen_wp_as_m_0_sum <- function(input_folder, fun = "sum"){
  
  years <- 2000:2020
  
  fnames <- paste0("global_m_0_", years, "_1km.tif")
  # fnames <- stringr::str_replace(Sys.glob("input/worldpop/*.tif"), "input/nl_black_marble/", "")
  
  var <- paste0("wp_as_m_0_", as.character(fun))
...
#'
#' @export
gen_wp_as_m_0_sd <- function(input_folder){
  gen_wp_as_m_0_sum(input_folder, fun = "sd")
}
...
#'
#' @export
gen_wp_as_m_0_max <- function(input_folder){
  gen_wp_as_m_0_sum(input_folder, fun = "max")
}
...
#'
#' @export
gen_wp_as_m_0_min <- function(input_folder){
  gen_wp_as_m_0_sum(input_folder, fun = "min")
}
...
#'
#' @export
gen_wp_as_m_0_mean <- function(input_folder){
  gen_wp_as_m_0_sum(input_folder, fun = "mean")
}
...
#'
#' @export
gen_wp_as_m_0_med <- function(input_folder){
  gen_wp_as_m_0_sum(input_folder, fun = "median")
}
