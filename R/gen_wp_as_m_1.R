...
#'
#' @export
gen_wp_as_m_1_sum <- function(input_folder, fun = "sum"){
  
  years <- 2000:2020
  
  fnames <- paste0("global_m_1_", years, "_1km.tif")
  
  var <- paste0("wp_as_m_1_", as.character(fun))
...
#'
#' @export
gen_wp_as_m_1_sd <- function(input_folder){
  gen_wp_as_m_1_sum(input_folder, fun = "sd")
}
...
#'
#' @export
gen_wp_as_m_1_max <- function(input_folder){
  gen_wp_as_m_1_sum(input_folder, fun = "max")
}
...
#'
#' @export
gen_wp_as_m_1_min <- function(input_folder){
  gen_wp_as_m_1_sum(input_folder, fun = "min")
}
...
#'
#' @export
gen_wp_as_m_1_mean <- function(input_folder){
  gen_wp_as_m_1_sum(input_folder, fun = "mean")
}
...
#'
#' @export
gen_wp_as_m_1_med <- function(input_folder){
  gen_wp_as_m_1_sum(input_folder, fun = "median")
}
