...
#'
#' @export
gen_wp_as_m_60_sum <- function(input_folder, fun = "sum"){
  
  years <- 2000:2020
  
  fnames <- paste0("global_m_60_", years, "_1km.tif")
  
  var <- paste0("wp_as_m_60_", as.character(fun))
...
#'
#' @export
gen_wp_as_m_60_sd <- function(input_folder){
  gen_wp_as_m_60_sum(input_folder, fun = "sd")
}
...
#'
#' @export
gen_wp_as_m_60_max <- function(input_folder){
  gen_wp_as_m_60_sum(input_folder, fun = "max")
}
...
#'
#' @export
gen_wp_as_m_60_min <- function(input_folder){
  gen_wp_as_m_60_sum(input_folder, fun = "min")
}
...
#'
#' @export
gen_wp_as_m_60_mean <- function(input_folder){
  gen_wp_as_m_60_sum(input_folder, fun = "mean")
}
...
#'
#' @export
gen_wp_as_m_60_med <- function(input_folder){
  gen_wp_as_m_60_sum(input_folder, fun = "median")
}
