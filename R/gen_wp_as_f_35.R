...
#'
#' @export
gen_wp_as_f_35_sum <- function(input_folder, fun = "sum"){
  
  years <- 2000:2020
  
  fnames <- paste0("global_f_35_", years, "_1km.tif")
  
  var <- paste0("wp_as_f_35_", as.character(fun))
...
#'
#' @export
gen_wp_as_f_35_sd <- function(input_folder){
  gen_wp_as_f_35_sum(input_folder, fun = "sd")
}
...
#'
#' @export
gen_wp_as_f_35_max <- function(input_folder){
  gen_wp_as_f_35_sum(input_folder, fun = "max")
}
...
#'
#' @export
gen_wp_as_f_35_min <- function(input_folder){
  gen_wp_as_f_35_sum(input_folder, fun = "min")
}
...
#'
#' @export
gen_wp_as_f_35_mean <- function(input_folder){
  gen_wp_as_f_35_sum(input_folder, fun = "mean")
}
...
#'
#' @export
gen_wp_as_f_35_med <- function(input_folder){
  gen_wp_as_f_35_sum(input_folder, fun = "median")
}
