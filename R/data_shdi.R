...
gen_msch <- function(path){ gen_shdi(path, variable == "msch") }
gen_esch <- function(path){ gen_shdi(path, variable == "esch") }
gen_lifexp <- function(path){ gen_shdi(path, variable == "lifexp") }
gen_lgnic <- function(path){ gen_shdi(path, variable == "lgnic") }
